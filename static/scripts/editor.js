...
switchtheme.addEventListener("click", (event) => {
    ...
    if (
        ...
        textarea.classList.replace("text-light", "text-info");
        textarea.classList.replace("bg-dark", "bg-primary");
        numbers.classList.replace("text-muted", "text-info");
        saveTheme("contrast-theme");
    } else {
        editor.classList.replace("contrast-theme", "normal-theme");
        editor.classList.remove("bg-dark");
        textarea.classList.remove("bg-primary", "text-info");
