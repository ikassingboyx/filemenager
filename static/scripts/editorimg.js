...
showFilters.addEventListener("click", () => {
    if(shown) {
        filtersDiv.setAttribute("style", "opacity : 0;")
        setTimeout(() => {
            secondDiv.setAttribute("style", "margin-top: 0px")
        }, 100)
        setTimeout(() => {
            filtersDiv.setAttribute("style", "display : none !important;")
        }, 2000)

    } else {
        secondDiv.setAttribute("style", "margin-top: 120px") 
        filtersDiv.setAttribute("style", "display : flex !important;")  
        filtersDiv.setAttribute("style", "opacity : 0;")

        setTimeout(() => {
            filtersDiv.setAttribute("style", "opacity : 1;")  
        }, 300)   
    }
    shown = !shown
})
